    ...
    return (
      <div>
        <button
          ...
          onClick={explain}
          disabled={isLoading}
          title="Get a quick summary: what happened, what they want, what you need to do"
          className="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-left text-xs font-medium text-slate-500 hover:bg-slate-50 hover:text-slate-700 hover:border-slate-300 disabled:cursor-not-allowed disabled:opacity-60 transition"
        >
  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
      <div className="mb-3 flex items-center justify-between gap-3">
        <h2 className="text-xs font-semibold text-slate-600">Explanation</h2>
        <span className={`rounded-full px-2 py-0.5 text-[10px] font-medium capitalize ${RISK_BADGE[explanation.riskLevel]}`}>
      ...
      <div className="space-y-3 text-xs">
        ...
        <button
          ...
          onClick={explain}
          disabled={isLoading}
          className="w-full rounded-lg border border-slate-200 px-3 py-1.5 text-xs font-medium text-slate-500 hover:bg-slate-50 disabled:opacity-60 transition"
        >
