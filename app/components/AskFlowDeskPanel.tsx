      ...
      >
        <div className="flex items-center justify-between border-b border-slate-200 px-4 py-3">
          ...
          <button
            ...
            className="rounded-full p-1.5 text-slate-400 transition hover:bg-slate-100 hover:text-slate-700 focus:outline-none focus:ring-2 focus:ring-[var(--color-accent-ring)]"
          >
