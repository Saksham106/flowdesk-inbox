...
const ACTION_COLORS: Record<string, string> = {
  ...
  "scheduling_session.confirmed": "bg-green-100 text-green-800",
  "scheduling_session.booking_approval_requested": "bg-amber-100 text-amber-800",
  "scheduling_session.booked": "bg-green-100 text-green-800",
  "scheduling_session.booking_failed": "bg-red-100 text-red-800",
